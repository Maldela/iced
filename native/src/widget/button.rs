...
impl<'a, Message, Renderer, S> Widget<Message, Renderer>
    for Button<'a, Message, Renderer, S>
where
    Renderer: self::Renderer<WidgetStyle = S>,
    Message: Clone,
{
...
impl<'a, Message, Renderer, S> From<Button<'a, Message, Renderer, S>>
    for Element<'a, Message, Renderer>
where
    Renderer: 'static + self::Renderer<WidgetStyle = S>,
    Message: 'static + Clone,
    S: 'static,
{
    fn from(
        button: Button<'a, Message, Renderer, S>,
